...
session_icon="$(tmux_get '@tmux_power_session_icon' '󱝂')"
...
RS="#[fg=$G01,bg=$G07]$left_arrow_icon#[fg=$TC,bg=$G01,italics]#{cpu_fg_color} 󰻠 #{cpu_icon} #{cpu_percentage} #[fg=$G07,bg=$G01]$left_arrow_icon$RS"

# Claude Code: number of interactive sessions running on this machine (bin/claude-ps)
RS="#[fg=$G07,bg=$BG]$left_arrow_icon#[fg=$TC,bg=$G07,italics] 󰚩 #(~/.dotfiles/bin/claude-ps -c) $RS"
