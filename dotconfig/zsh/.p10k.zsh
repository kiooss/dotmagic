# Generated by Powerlevel10k configuration wizard on 2021-08-09 at 16:29 JST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%244F╰─%2F❯'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%244F╰%2F❯%3F❯%4F❯'
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='\uE05'
  ...
  function prompt_git_remote() {
    ...
    if [[ -n "$GIT_REMOTE" ]]; then
      p10k segment -b 3 -f '' -i '' -t "$GIT_REMOTE"
    fi
  }
  #! add by me end
